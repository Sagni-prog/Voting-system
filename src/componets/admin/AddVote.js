 ...
 try {
  ...
  try {
    ...
    const http = axios.create({
     ...
     const res = await http.post('/vote',data);
     const user = res.data;
  ...
  //  }
    ...
    const handleSubmit = (event) => {
      ...
      formData.append("vote_name",voteName);
      formData.append("vote_start_date",voteStartDate);
      formData.append("vote_end_date", voteEndDate);
  ...
  <Sidebar />
    ...
    <h2 class="text-2xl font-bold mb-4">New Election</h2>
    ...
    <div className='flex gap-4'>
      ...
      <div class="mb-4 w-full">
        ...
        <input
          ...
          placeholder="Enter Vote end date"
        />
      </div>
      </div>
