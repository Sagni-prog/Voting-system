  ...
  <form>
   <div class="w-full mb-4 border border-emerald-200 rounded-lg bg-emerald-50 dark:bg-emerald-700 dark:border-emerald-600">
       ...
       <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-emerald-800">
           ...
           <textarea id="editor" rows="8" style={{ transform: `scale(${scale})` }} class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-emerald-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea>
       </div>
   </div>
