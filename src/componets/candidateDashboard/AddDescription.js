...
export default function AddDescription() {
    ...
    const handleSubmit = (event) => {
        try{
          ...
          formData.append("candidates_description",description);
     ...
     const sendDescription = async(data) => {
        ...
        const res = await http.post('/description',data);
...
<Sidebar />
  ...
  <h2 class="text-2xl font-bold mb-10">Add Description</h2>
  <div className='mb-2'>
  ...
  <div className='flex gap-4'>
      ...
      <div class="mb-4 w-full">
       ...
       <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-emerald-800">
           ...
           <textarea id="editor" rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-emerald-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write your descriptions here..." required
              value={description}
