...
export default function Sidebar() {
  ...
  <div class="bg-emerald-800 text-white py-2 px-4 h-full w-[18rem]">
    ...
    <li className='h-[2rem] mb-2 p-5'>
                 <Link to="/CandidateDashboardHome" replace={true} smooth={true} duration={500} className="flex gap-3 text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-600" aria-current="page">
                 <IoIosPeople class="w-[2rem] h-[2rem] bg-blue-600 p-1 rounded" />Home</Link>
    </li>
    <li className='h-[2rem] mb-2 p-5'>
                 <Link to="/Addpolicyandstrategy" replace={true} smooth={true} duration={500} className="flex gap-3 text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-600" aria-current="page">
                 <IoIosPeople class="w-[2rem] h-[2rem] bg-blue-600 p-1 rounded" />Add Strategies </Link>
    </li>
   
    <li className='h-[2rem] mb-2 p-5'>
                 <Link to="/CandidateDashboardHome" replace={true} smooth={true} duration={500} className="block gap-3 text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-600" aria-current="page">
